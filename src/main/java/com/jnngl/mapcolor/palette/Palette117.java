...
public class Palette117 implements Palette {
   ...
   static {
      palette = new Color[] {
              ...
              new Color(10, 95, 70),
              new Color(70, 70, 70), // Base 59
              new Color(86, 86, 86),
              new Color(100, 100, 100),
              new Color(52, 52, 52),
              new Color(152, 123, 103), // Base 60
              new Color(186, 150, 126),
              new Color(216, 175, 147),
              new Color(114, 92, 77),
              new Color(89, 117, 105), // Base 61
   ...
   public static final byte DEEPSLATE_ID = 59;
   public static final byte RAW_IRON_ID = 60;
   public static final byte GLOW_LICHEN_ID = 61;
